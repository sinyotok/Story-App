package com.aryanto.storyapp.ui.custom_view
...
class EmailEdt : LinearLayout {
    ...
    private fun initView(context: Context) {
        inflate(context, R.layout.custom_email_edt, this)
        tiLayout = findViewById(R.id.custom_email_ti_layout)
        editText = findViewById(R.id.custom_email_edt)
